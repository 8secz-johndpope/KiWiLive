...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = (RoundedImageView) view.findViewById(R.id.fiv);
            ll_del = (RelativeLayout) view.findViewById(R.id.ll_del);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.icon_img0);
...
//            if (mimeType == PictureMimeType.ofAudio()) {
//                Glide.with(context).load(R.drawable.audio_placeholder).into( viewHolder.mImg);
//            } else {
